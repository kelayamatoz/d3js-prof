...
`
  ...
  main.variable(observer("data")).define("data", ["buildHierarchy", "csv"], function (buildHierarchy, csv) {
    return (
      buildHierarchy(csv)
    )
  });
  main.variable(observer("partition")).define("partition", ["d3", "radius"], function (d3, radius) {
    return (
      data =>
  ...
  main.variable(observer("mousearc")).define("mousearc", ["d3", "radius"], function (d3, radius) {
    return (
      d3
        .arc()
        .startAngle(d => d.x0)
  ...
  main.variable(observer("buildHierarchy")).define("buildHierarchy", function () {
    return (
  ...
  main.variable(observer("breadcrumbWidth")).define("breadcrumbWidth", function () {
    return (
      75
    )
  });
  main.variable(observer("breadcrumbHeight")).define("breadcrumbHeight", function () {
    return (
      30
    )
  });
  main.variable(observer("breadcrumbPoints")).define("breadcrumbPoints", ["breadcrumbWidth", "breadcrumbHeight"], function (breadcrumbWidth, breadcrumbHeight) {
    return (
