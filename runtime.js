...
var X = Function.prototype.toString, Q = {prefix: "async ƒ"}, Z = {prefix: "async ƒ*"}, ee = {prefix: "class"},
...
const de = new Map, fe = [], pe = fe.map, he = fe.some, me = fe.hasOwnProperty, ve = "https://cdn.jsdelivr.net/npm/",
    be = /^((?:@[^/@]+\/)?[^/@]+)(?:@([^/]+))?(?:\/(.*))?$/, _e = /^\d+\.\d+\.\d+(-[\w-.+]+)?$/, we = /\.[^/]*$/,
...
var xe = Ce((async function (e, t) {
    ...
    const r = await Ee(n);
    return `${ve}${r.name}@${r.version}/${n.path || function (e) {
        for (const t of ge) {
            const n = e[t];
            if ("string" == typeof n) return we.test(n) ? n : `${n}.js`
        }
    }(r) || "index.js"}`
}));
...
function Ne(e) {
    const t = {};
    for (const n of e) for (const e in n) me.call(n, e) && (null == n[e] ? Object.defineProperty(t, e, {get: Se(n, e)}) : t[e] = n[e]);
    return t
}
...
var ke = {
    canvas: function (e, t) {
        ...
        if (t) for (var a in t) i = (r = a).indexOf(":"), n = t[a], i >= 0 && "xmlns" !== (r = a.slice(0, i)) && (a = a.slice(i + 1)), $e.hasOwnProperty(r) ? o.setAttributeNS($e[r], a, n) : o.setAttribute(a, n);
        return o
    }, input: function (e) {
...
var De = {
    disposable: Te, filter: function* (e, t) {
...
function Fe(e, t) {
    return function (n) {
        var r, i, o, a, s, l, u, c, d = n[0], f = [], p = null, h = -1;
...
var nt = Object.assign((function (e) {
    const t = Je(e);
    Object.defineProperties(this, {
        DOM: {value: ke, writable: !0, enumerable: !0},
        FileAttachment: {value: Me(ce), writable: !0, enumerable: !0},
        Files: {value: Ae, writable: !0, enumerable: !0},
        Generators: {value: De, writable: !0, enumerable: !0},
        html: {value: Me(Ie), writable: !0, enumerable: !0},
        md: {value: Be(t), writable: !0, enumerable: !0},
        Mutable: {value: Me(He), writable: !0, enumerable: !0},
        now: {value: We, writable: !0, enumerable: !0},
        Promises: {value: Ke, writable: !0, enumerable: !0},
        require: {value: Me(t), writable: !0, enumerable: !0},
        resolve: {value: Me(Ye), writable: !0, enumerable: !0},
        svg: {value: Me(Xe), writable: !0, enumerable: !0},
        tex: {value: et(t), writable: !0, enumerable: !0},
        width: {value: tt, writable: !0, enumerable: !0}
    })
}), {resolve: xe.resolve});
...
var it = Array.prototype, ot = it.map, at = it.forEach;
...
function dt(e, t, n) {
    ...
    null == n && (n = ct), Object.defineProperties(this, {
        ...
        _definition: {value: ht, writable: !0},
...
function vt(e, t, n) {
    ...
    if (this._inputs.forEach(pt, this), t.forEach(ft, this), this._inputs = t, this._definition = n, this._value = void 0, n === ut ? i._variables.delete(this) : i._variables.add(this), e == this._name && r.get(e) === this) this._outputs.forEach(i._updates.add, i._updates); else {
        var o, a;
...
function bt(e, t = []) {
    Object.defineProperties(this, {
        ...
        _builtins: {value: new Map([["invalidation", gt], ["visibility", yt], ...t])},
    ...
    _copy: {
        value: function (e, t) {
            ...
            for (const [o, a] of this._scope) {
                ...
                if (!n || 1 !== n._type) if (a._definition === lt) {
                    var r = a._inputs[0], i = r._module;
        ...
        value: function (e) {
            ...
            if (!n) if (n = new dt(2, this), this._builtins.has(e)) n.define(e, st(this._builtins.get(e))); else if (this._runtime._builtin._scope.has(e)) n.import(e, this._runtime._builtin); else {
                try {
        ...
        value: function (e, t) {
            ...
            return n._source = this, at.call(e, (function (e) {
                ...
                for (const t of e) for (const n of t._scope.values()) if (n._definition === lt) {
...
function Et(e = new nt, t = jt) {
    ...
    if (Object.defineProperties(this, {
        ...
        _builtin: {value: n},
        _global: {value: t}
    }), e) for (var r in e) new dt(2, n).define(r, [], e[r])
}
...
function qt(e, t) {
    let n, r, i = "function" == typeof IntersectionObserver && t._observer && t._observer._node, o = !i, a = ut, s = ut;
...
function Mt(e) {
    ...
    var t = e._value, n = ++e._version, r = null, i = e._promise = Promise.all(e._inputs.map(St)).then((function (i) {
        if (e._version === n) {
...
Object.defineProperties(Et, {
    load: {
        value: function (e, t, n) {
            ...
            null == t && (t = new nt);
            const {modules: r, id: i} = e, o = new Map, a = new Et(t), s = l(i);
...
export {le as Inspector, nt as Library, Et as Runtime, rt as RuntimeError};
